...
\begin{tikzpicture}
                \begin{axis}[
                        ...
                        bar width=25pt,
                        ymajorgrids = true,
                        symbolic x coords={Sistema de arquivos com \texttt{10MB}
                        ocupado},
                        xtick = data,
                    ...
                    y explicit]
                    coordinates {
                        (Sistema de arquivos com \texttt{10MB} ocupado, 1.985)
                        += (0,0.049) -= (0,0.049)
                    };
                    ...
                    y explicit]
                    coordinates {
                        (Sistema de arquivos com \texttt{10MB} ocupado, 1.583)
                        += (0,0.016) -= (0,0.016)
                    };
                    ...
                    y explicit]
                    coordinates {
                        (Sistema de arquivos com \texttt{10MB} ocupado, 1.316)
                        += (0,0.0787) -= (0,0.0787)
                    };
